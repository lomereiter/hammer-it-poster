...
%      Ion Torrent PGM Data'' \emph{(PLoS~Comput~Biol~9(4))}     
  ...
  \begin{textblock}{0.320}(0.465, 0.075)
    \begin{block}{Error reduction results\phantom{p}}
      ...
      \begin{figure}[h]
        ...
        \includegraphics[width=0.90\textwidth]{images/error_rate}
      \end{figure}

      \begin{figure}[h]
        \caption{Error reduction by read position for Sakai 400bp reads}
        \includegraphics[width=0.90\textwidth]{images/error_rate_vs_offset}
      \end{figure}
    \end{block}
  \end{textblock}

  \begin{textblock}{0.215}(0.01, 0.64)
    \begin{block}{Pairwise distance calculation \phantom{p}}
  ...
  \begin{textblock}{0.215}(0.790, 0.075)
