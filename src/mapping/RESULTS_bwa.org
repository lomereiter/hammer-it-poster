...
#+begin_src R :session :results graphics :file "../../images/error_rate.pdf" :width 9 :height 3 :var df4s=400bp-sakai :var df3s=300bp-sakai :var df2s=200bp-sakai :var df1s=100bp-sakai :var df4d=400bp-dh10b :var df2d=200bp-dh10b
    ...
    df$error.type <- factor(df$variable, labels=c("Indels", "Mismatches"))
