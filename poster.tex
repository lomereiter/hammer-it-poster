...
\begin{block}{Results}
  \begin{columns}[t]
    \begin{column}{0.47\textwidth}
      ...
      314v2~chip, which were published recently on Ion~Community~Portal.
      ...
      output. In all cases, change in read coverage after correction
      stayed within 0.4\%.
    ...
    \begin{column}{0.32\textwidth}
      ...
      \item \hspace{\algorithmicindent}\emph{(Combining corrected parts)}
          \For{\textbf{each} corrected \textit{part}}
            ...
            \State align last 8 bases against the read sequence
            \State align first 8 bases of the next part
            \If{there is a gap between the two parts}
              \State copy read bases as is
            \Else
