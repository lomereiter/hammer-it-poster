...
\begin{frame}
  ...
  \begin{textblock}{0.215}(0.780, 0.06)
    \begin{block}{Assembly results}
      We have assembled \emph{E.coli O157 H7 Sakai} 400bp reads before and after correction with MIRA 3.4.1.1 and SPAdes 2.4.0. For
      the MIRA assembler, the reads were subsampled to get $_{\widetilde{~}}$40x coverage as recommended by the authors of the
      original benchmark, whereas SPAdes assembler operated on the full dataset ($_{\widetilde{~}}$200x).

      Length of the reference genome is 5498450 bp.
      \vspace{0.1em}
      \begin{table}[ht]
        \caption{Assembly results, E.coli Sakai dataset (400bp). Contigs of length $\geq 500$ are used.}
      \begin{tabularx}{\textwidth}{>{\fontsize{21.5}{24}\fontencoding{T1}\fontfamily{lmss}\fontseries{b}\selectfont}X|c|c|c|c}\toprule
                                    & \multicolumn{2}{c|}{\bfseries MIRA 3.4.1.1} & \multicolumn{2}{c}{\bfseries SPAdes 2.4.0}   \\
                                    \cline{2-3} \cline{4-5}
                                    & uncorrected                     & corrected & uncorrected & corrected \\ \midrule
                                    
        \# contigs                 \rule{0pt}{4ex} & \textbf{178}    & 197             & 266            & 242            \\[1.0em]
        Largest contig                             & \textbf{378520} & 378249          & 316904         & 374932         \\[1.0em]
        Total length                               & 5510229         & 5517674         & 5322223        & 5320566        \\[1.0em]
        NG50                                       & \textbf{147710} & 124917          & 106242         & 146551         \\[1.0em]
        NG75                                       & \textbf{73050}  & 67854           & 41186          & 44318          \\[1.0em]
        \# misassemblies                           & 23              & 19              & \textbf{0}     & 2              \\[1.0em]
        \# local misassemblies                     & 17              & 20              & \textbf{8}     & 11             \\[1.0em]
        Misassembled contigs length                & 842594          & 567793          & \textbf{0}     & 32563          \\[1.0em]
        Genome fraction (\%)                       & 97.241          & \textbf{97.441} & 93.880         & 93.966         \\[1.0em]
        Duplication ratio                          & 1.011           & 1.015           & \textbf{1.001} & \textbf{1.001} \\[1.0em]
        \# mismatches per 100 kbp                  & 12.68           & 22.25           & \textbf{3.58}  & 4.70           \\[1.0em]
        \# indels per 100 kbp                      & 9.85            & 6.64            & 6.21           & \textbf{5.88}  \\\bottomrule
      \end{tabularx}
      \end{table}
      ...
      \begin{table}[ht]
        \begin{tabularx}{\textwidth}{c|>{\tt\footnotesize}X}\hline
          MIRA 3.4.1.1 & --job=denovo,genome,accurate,iontor --notraceinfo IONTOR\_SETTINGS -ASSEMBLY:mprc=100 \\ \hline
          SPAdes 2.4.0 & --only-assembler -k 21,33,55,77,99 \\
        \end{tabularx}
      \end{table}
      }
  ...
  \begin{textblock}{0.200}(0.465, 0.65)
    ...
    \begin{block}{Cluster size distribution}
      \begin{figure}
        \includegraphics[width=\textwidth]{images/clustersize}
      \end{figure}
    \end{block}
  \end{textblock}
